...
from app.modules.user.schemas import UserLoginRequest, UserRegisterRequest
from app.core.current_user import CurrentUser
from app.core.response import ApiResponse, success_response
from app.modules.user.service import UserService, build_user_response
...
async def get_register_status(
    ...
    return success_response(request, await service.get_register_status())
...
async def register_user(
    ...
    return success_response(request, await service.register_user(payload))
...
async def login_user(
    ...
    return success_response(request, await service.login_user(payload))
